...
BANNER_SUBTITLE = 'Music, Investing, Ventures, Ideas'
...
SOCIAL = (('Github', 'https://github.com/GrilledChickenThighs'),
          ...
          ('SoundCloud', 'https://www.soundcloud.com/paulse-1'))
GITHUB_USER = "grilledchickenthighs"
GITHUB_REPO_COUNT = 3
GITHUB_SKIP_FORK = True
GITHUB_SHOW_USER_LINK = True
GOOGLE_ANALYTICS = "UA-124205457-1"
TWITTER_USERNAME='BTCTradeNation'
